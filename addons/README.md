...
Ce projet implémente une solution pour afficher des entités géographiques (EPCI, communes, SCOT) sur une carte interactive en se basant sur des paramètres passés dans l'URL. Il utilise la bibliothèque OpenLayers pour gérer les données géographiques et manipuler les couches affichées sur la carte.
...
> [!CAUTION]
>Le filtrage CQL pour les SCOTs ne fonctionnent pas, il faut donc filtrer côté client.
---
